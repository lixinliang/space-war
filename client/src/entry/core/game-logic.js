...
Logic.prototype = {
    ...
    hitUser: function(id) {
        ...
        if (this.userList[id].life <= 0) {
            this.delUser(id);
            self.opts.userDeath && self.opts.userDeath(id);
    ...
    shot: function(userA, userB) {
        ...
        var shell = this.addShell(this.createShell(userA.x, userA.y, speed, moveX, moveY, userA.id));
        return shell;
    ...
    ticker: function() {
        ...
        this.timer = setTimeout(function() {
            self.ticker();
            self.opts.ticker && self.opts.ticker();
        }, 1000 / 60);
    },
    // 游戏主逻辑
    main: function() {
